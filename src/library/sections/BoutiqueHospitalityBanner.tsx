...
const BoutiqueHospitalityBannerFields: YextFields<BoutiqueHospitalityBannerProps> = {
  data: {
    label: "Banner Text",
    type: "object",
    objectFields: {
...
const BoutiqueHospitalityBannerComponent: PuckComponent<BoutiqueHospitalityBannerProps> = ({
  data,
  styles,
  section,
  puck,
...
export const BoutiqueHospitalityBanner: YextComponentConfig<BoutiqueHospitalityBannerProps> = {
  label: "Banner",
  fields: toPuckFields(BoutiqueHospitalityBannerFields),
  defaultProps: {
    data: {
      text: {
        field: "",
  ...
  render: (props) => (
    ...
    >
      <BoutiqueHospitalityBannerComponent {...props} />
    </VisibilityWrapper>
  ),
};

export const config: SectionConfig = {
  id: "BoutiqueHospitalityBanner",
  displayName: "Banner",
  description: "Banner",
  pageSetTypes: ["ENTITY"],
};
